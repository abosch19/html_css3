...
var API_WORLDTIME_KEY = "d8e9ef7ffd45897c82e65e3b2e3a0"
var API_WORLDTIME_URL = "https://api.worldweatheronline.com/free/v2/tz.ashx?format=json&key=" + API_WORLDTIME_KEY + "&q=";
var API_WEATHER_KEY = "b1a7be86ea6860a29910ff4a9beaef48";
var API_WEATHER_URL = "http://api.openweathermap.org/data/2.5/weather?APPID=" + API_WEATHER_KEY + "&";
var IMG_WEATHER = "http://openweathermap.org/img/w/"

var today = new Date();
var timeNow = today.toLocaleTimeString().split(":")[0] + ":" + today.toLocaleTimeString().split(":")[1];
